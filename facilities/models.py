...
class Facility_Info(models.Model):
    ...
    county = models.ForeignKey(Counties, on_delete=models.CASCADE, default=None)
    sub_county = models.ForeignKey(Sub_counties, on_delete=models.CASCADE, default=None, blank=True, null=True)
    lat = models.DecimalField(max_digits=13, decimal_places=10, default=None, blank=True, null=True)
...
class EMR_Info(models.Model):
    ...
    date_of_emr_impl = models.DateField(default=None, blank=True, null=True)
    ...
    hiv = models.BooleanField(default=False, blank=True, null=True)
    tpt = models.BooleanField(default=False, blank=True, null=True)
    covid_19 = models.BooleanField(default=False, blank=True, null=True)
    evmmc = models.BooleanField(default=False, blank=True, null=True)
...
class IL_Info(models.Model):
    ...
    lab_manifest = models.BooleanField(default=False, blank=True, null=True)
    nimeconfirm = models.BooleanField(default=False, blank=True, null=True)
